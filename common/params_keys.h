...
inline static std::unordered_map<std::string, uint32_t> keys = {
    ...
    {"e2e_link", PERSISTENT},
    {"FlaskInstallCompleted", PERSISTENT},
    {"FlaskInstallFailed", PERSISTENT},
    {"FlaskInstallInProgress", PERSISTENT},
    {"FlaskInstallRequested", PERSISTENT},
    ...
    {"road_edge_detection", PERSISTENT},
