...
inline static std::unordered_map<std::string, ParamKeyAttributes> keys = {
    ...
    {"IsLdwEnabled", {PERSISTENT, BOOL, "1"}},
    ...
    // TOP
    {"AccelPersonality", {PERSISTENT, BOOL}},
    ...
    {"dp_jetson", {PERSISTENT, BOOL}},
    {"DrivingPersonalitiesUIWheel", {PERSISTENT, BOOL}},
    {"e2e_link", {PERSISTENT, BOOL, "1"}},
    {"FlaskInstallCompleted", {PERSISTENT, BOOL}},
    {"FlaskInstallFailed", {PERSISTENT, BOOL}},
    {"FlaskInstallInProgress", {PERSISTENT, BOOL}},
    ...
    {"toyotaautolock", {PERSISTENT, BOOL, "1"}},
    {"toyotaautounlock", {PERSISTENT, BOOL, "1"}},
