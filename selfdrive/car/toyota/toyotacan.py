...
def create_accel_command(packer, accel, accel_raw, pcm_cancel, standstill_req, lead, acc_type, fcw_alert, should_compensate, distance, reverse_acc):
  ...
  values = {
    ...
    "ACCEL_CMD_ALT": accel_raw if should_compensate else accel,
  }
