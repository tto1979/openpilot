...
from selfdrive.car.toyota.values import ToyotaFlags, TSS2_CAR, RADAR_ACC_CAR
...
class LongitudinalMpc:
  ...
  def update(self, carstate, radarstate, v_cruise, x, v, a, j, prev_accel_constraint, personality=log.LongitudinalPersonality.standard):
    v_ego = self.x0[1]
