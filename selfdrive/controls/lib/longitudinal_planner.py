...
A_CRUISE_MIN_VALS =    [-0.04, -0.03, -0.001, -0.01, -0.15, -0.22, -0.35, -0.55, -0.75, -1.0, -0.65]
...
A_CRUISE_MIN_VALS_DF = [-0.030, -0.030, -0.100, -0.100, -0.38, -0.38, -0.58, -0.58, -0.78, -0.78, -1.0,  -1.0]
A_CRUISE_MIN_BP_DF =   [ 0.,     5.0,    5.01,   10.,    10.01, 14.,   14.01, 18.,   18.01,  22.,  22.01, 30.]
A_CRUISE_MAX_VALS_DF =       [2.0, 2.0, 1.8, 1.35, 0.86, .53,  .43,  .32,  .09]  # Sets the limits of the planner accel, PID may exceed
A_CRUISE_MAX_BP_DF =         [0.,  4.,  6.,  8.,   11.,  20.,  25.,  30.,  40.]
