...
A_CRUISE_MIN_VALS_DF = [-0.015, -0.015, -1.2, -1.2, -1.2, -1.2, -1.2, -1.2]
A_CRUISE_MIN_BP_DF =   [0.,     2.0,    2.01, 15.,  15.01, 20., 20.01, 40.]
A_CRUISE_MAX_VALS_DF =       [3.0, 1.7, 1.3, .95, .82, .68, .53, .32, .20, .085]  # Sets the limits of the planner accel, PID may exceed
