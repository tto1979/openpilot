...
A_CRUISE_MIN_VALS =    [-1.02, -0.25, -0.001, -0.01, -0.15, -0.22, -0.28, -0.35, -0.65, -0.65]
...
A_CRUISE_MIN_VALS_DF = [-0.20, -0.20, -0.30, -0.30, -0.35, -0.80, -0.80]
A_CRUISE_MIN_BP_DF =   [ 0.,    8.32,  8.33,  15.99, 16.,   30.,   40.]
A_CRUISE_MAX_VALS_DF =       [3.0, 2.0, 2.0, 1.4, .80, .68, .53, .32, .20, .085]  # Sets the limits of the planner accel, PID may exceed
