...
# A_CRUISE_MIN_VALS =  [-0.2, -0.11, -0.1,   -0.15, -0.35, -0.55, -0.85, -1.0, -1.0]
A_CRUISE_MIN_VALS =    [-0.3, -0.25, -0.001, -0.01, -0.15, -0.25, -0.33, -0.42, -0.65]
A_CRUISE_MIN_BP =      [ 0.,   .01,   .02,    .3,     5.,    8.,    11.,   16.,   22.]
A_CRUISE_MIN_VALS_DF = [-0.22, -0.22, -0.25, -1.0, -1.2]
A_CRUISE_MIN_BP_DF =   [0.,    5.,    11.,   20.,  30.]
A_CRUISE_MAX_VALS_DF =       [3.0, 1.7, 1.3, .70, .60, .44, .32, .22, .16, .078]  # Sets the limits of the planner accel, PID may exceed
...
A_CRUISE_MAX_VALS_TOYOTA =   [2.0, 1.7, 1.32, 1.22, 1.02, .87, .73, .58, .38, .24, .085]  # Sets the limits of the planner accel, PID may exceed
