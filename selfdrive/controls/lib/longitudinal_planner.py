...
A_CRUISE_MIN_VALS_DF = [-1.00,  -1.00,  -0.93,  -0.93,  -0.90,  -0.88,  -0.86,  -0.80]
...
A_CRUISE_MAX_VALS_TOYOTA =   [2.0, 2.0,  1.35, 1.22, 0.98, 0.85, 0.72, 0.57, 0.37, 0.32, 0.08]  # Sets the limits of the planner accel, PID may exceed
