...
A_CRUISE_MIN_VALS =    [-0.15, -0.03, -0.001, -0.01, -0.15, -0.22, -0.35, -1.0, -1.0]
A_CRUISE_MIN_BP =      [ 0.,   .01,   .02,    .3,     5.,    8.,    11.,   16.,  22.]
A_CRUISE_MIN_VALS_DF = [-0.030, -0.030, -0.15, -0.15, -1.0,  -1.0]
...
A_CRUISE_MAX_VALS_TOYOTA =   [2.0, 1.7, 1.3, 1.15, .80, .73, .65, .53, .32, .20, .085]  # Sets the limits of the planner accel, PID may exceed
