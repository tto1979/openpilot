...
A_CRUISE_MIN_VALS_DF = [-0.04, -0.04, -0.087, -0.087, -0.24, -0.24, -0.38, -0.38, -0.65]
A_CRUISE_MIN_BP_DF =   [ 0.,    5.0,   5.01,   11.1,   11.11, 20.,   20.01, 30.,   30.01]
A_CRUISE_MAX_VALS_DF =       [2.0, 2.0, 1.6, 1.33, 0.86, .53, .42, .31, .085]  # Sets the limits of the planner accel, PID may exceed
A_CRUISE_MAX_BP_DF =         [0.,  1.,  6.,  8.,   11.,   20., 25., 30., 55.]
