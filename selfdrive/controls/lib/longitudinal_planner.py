...
A_CRUISE_MIN_VALS_DF = [-0.030, -0.030, -0.075, -0.075, -0.18, -0.18, -0.58, -0.58, -0.78, -0.78, -1.0,  -1.0]
A_CRUISE_MIN_BP_DF =   [ 0.,     3.0,    3.01,   10.,    10.01, 14.,   14.01, 18.,   18.01,  22.,  22.01, 30.]
A_CRUISE_MAX_VALS_DF =       [2.0, 2.0, 1.8, 1.40, 0.90, .53,  .43,  .32,  .09]  # Sets the limits of the planner accel, PID may exceed
