...
A_CRUISE_MIN_VALS_DF = [-0.030, -0.030, -0.100, -0.100, -0.40, -0.40, -1.0,  -1.0, -0.65]
A_CRUISE_MIN_BP_DF =   [ 0.,     5.0,    5.01,  10.,    10.01, 15.,   15.01, 30.,  30.01]
A_CRUISE_MAX_VALS_DF =       [2.0, 2.0, 1.8, 1.35, 0.86, .53,  .42,  .31,  .085]  # Sets the limits of the planner accel, PID may exceed
A_CRUISE_MAX_BP_DF =         [0.,  4.,  6.,  8.,   11.,  20.,  25.,  30.,  55.]
