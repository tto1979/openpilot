...
#A_CRUISE_MIN_VALS =   [-1.02,  -1.00, -0.01, -0.15, -0.22, -0.28, -0.35, -0.65, -0.65]
A_CRUISE_MIN_VALS =    [-1.02,  -1.00,  -0.98,  -0.82,  -0.73,  -0.73,  -0.80,  -0.80]
#A_CRUISE_MIN_BP =     [ 0.,    .01,    .3,    5.,    8.,    11.,   16.,   28.,   42.]
A_CRUISE_MIN_BP =      [ 0.,     0.05,   0.4,    0.5,    8.33,   16.,    30.,    40.]
A_CRUISE_MIN_VALS_DF = [-1.02,  -1.00,  -0.98,  -0.82,  -0.73,  -0.73,  -0.80,  -0.80]
A_CRUISE_MIN_BP_DF =   [ 0.,     0.05,   0.4,    0.5,    8.33,   16.,    30.,    40.]
A_CRUISE_MAX_VALS_DF =       [2.0, 2.0, 2.0, 1.4, .80,   .68,  .53,  .32,  .20,  .085]  # Sets the limits of the planner accel, PID may exceed
...
A_CRUISE_MAX_VALS_TOYOTA =   [2.0, 2.0,  1.55, 1.22, .95, .82, .68, .53, .32, .20, .085]  # Sets the limits of the planner accel, PID may exceed
