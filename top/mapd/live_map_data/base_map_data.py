...
from openpilot.top.navd.helpers import Coordinate, coordinate_from_param
...
class BaseMapData(ABC):
  def __init__(self):
    ...
    self.pm = messaging.PubMaster(['liveMapDataTOP'])
  ...
  def publish(self) -> None:
    ...
    mapd_top_send = messaging.new_message('liveMapDataTOP')
    mapd_top_send.valid = self.sm.all_checks(service_list=[self.gps_location_service, 'livePose'])
    live_map_data = mapd_top_send.liveMapDataTOP
    ...
    self.pm.send('liveMapDataTOP', mapd_top_send)
