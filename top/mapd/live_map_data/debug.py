...
from openpilot.top.selfdrive.controls.lib.speed_limit_controller.common import Policy
from openpilot.top.selfdrive.controls.lib.speed_limit_controller.speed_limit_resolver import SpeedLimitResolver
from openpilot.top.mapd.live_map_data import get_debug
...
def live_map_data_top_thread():
  ...
  while True:
    live_map_data_top_thread_debug(gps_location_service)
