...
from openpilot.top.mapd.live_map_data.osm_map_data import OsmMapData
from openpilot.system.hardware.hw import Paths
from openpilot.top.mapd import MAPD_PATH
from openpilot.top.mapd.mapd_installer import VERSION, update_installed_version
