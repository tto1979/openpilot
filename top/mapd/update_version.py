...
from openpilot.top import get_file_hash
from openpilot.common.basedir import BASEDIR
from openpilot.top.mapd import MAPD_PATH

MAPD_HASH_PATH = os.path.join(BASEDIR, "top", "mapd", "tests", "mapd_hash")
MAPD_VERSION_PATH = os.path.join(BASEDIR, "top", "mapd", "mapd_installer.py")
...
if __name__ == "__main__":
  ...
  if not args.new_ver:
    ...
    print("Example:")
    print("  python top/mapd/update_version.py --new_ver \"v1.12.0\"")
