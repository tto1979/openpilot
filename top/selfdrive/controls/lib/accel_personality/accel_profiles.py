...
# Profiles
MAX_ACCEL_PROFILES = {
  "eco":                [2.0, 2.0, 1.9, 1.85, 1.1, .55, .40, .36, .28, .22, .08],
  "normal":             [2.0, 2.0, 2.0, 1.9,  1.2, .83, .61, .54, .45, .38, .15],
  "sport":              [2.0, 2.0, 2.0, 1.95, 1.8, 1.1, .82, .71, .55, .48, .25],
}
MAX_ACCEL_BREAKPOINTS = [0.,  1,   3.,  6.,   8.,  11.,  16., 20., 25., 30., 55.]

MIN_ACCEL_PROFILES = {
  "eco":                [-.20, -.26,  -.3, -.34, -.45, -1.2, -1.20],
  "normal":             [-.22, -.28, -.32, -.36, -.45, -1.2, -1.22],
  "sport":              [-.24,  -.3, -.34, -.38,  -.5, -1.2, -1.24],
  "stock":              [-1.2, -1.2, -1.2, -1.2, -1.2, -1.2, -1.20],
}
