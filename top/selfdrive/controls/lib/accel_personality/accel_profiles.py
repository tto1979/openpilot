...
# Profiles
MAX_ACCEL_PROFILES = {
  "eco":                [2.4, 1.8, 1.0,  .75, .60, .55, .40, .36, .28, .22, .08],
  "normal":             [2.7, 2.4, 1.5, 1.22, .95, .83, .61, .54, .45, .38, .15],
  "sport":              [3.0, 2.6, 2.2, 1.55, 1.3, 1.1, .82, .71, .55, .48, .25],
}
MAX_ACCEL_BREAKPOINTS = [0.,  1,   3.,  6.,   8.,  11.,  16., 20., 25., 30., 55.]

MIN_ACCEL_PROFILES = {
  "eco":                [-.07115, -.1713, -.272, -.372, -1.2, -1.2],
  "normal":             [-.07117, -.1714, -.273, -.373, -1.2, -1.2],
  "sport":              [-.07119, -.1715, -.274, -.374, -1.2, -1.2],
