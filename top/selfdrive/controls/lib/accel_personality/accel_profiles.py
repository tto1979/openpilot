...
# Profiles
MAX_ACCEL_PROFILES = {
  "eco":                [2.0, 1.7, 1.0,  .85, .70, .60, .44, .32, .22, .16, .01],
  "normal":             [2.2, 1.9, 1.4, 1.22, .95, .83, .71, .54, .45, .38, .15],
  "sport":              [3.0, 2.4, 2.0, 1.55, 1.3, 1.1, .92, .75, .63, .55, .25],
}
MAX_ACCEL_BREAKPOINTS = [0.,  1,   3.,  6.,   8.,  11.,  16., 20., 25., 30., 55.]

MIN_ACCEL_PROFILES = {
  "eco":                [-.06,  -.06,  -.11,  -.11, -.0705, -.0705, -.072, -1.2, -1.2],
  "normal":             [-.07,  -.07,  -.12,  -.12, -.0708, -.0708, -.072, -1.2, -1.2],
  "sport":              [-1.2,  -1.2,  -1.2,  -1.2, -1.2,  -1.2,  -1.2,  -1.2, -1.2],
  "stock":              [-1.2,  -1.2,  -1.2,  -1.2, -1.2,  -1.2,  -1.2,  -1.2, -1.2],
}
MIN_ACCEL_BREAKPOINTS = [0.,    0.5,    0.6,    1.2,    8.,    12.,   14.,   22.2,  40.]
