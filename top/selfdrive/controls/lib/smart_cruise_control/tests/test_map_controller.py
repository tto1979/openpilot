...
from openpilot.top.selfdrive.controls.lib.smart_cruise_control.map_controller import SmartCruiseControlMap

MapState = VisionState = custom.LongitudinalPlanTOP.SmartCruiseControl.MapState
...
class TestSmartCruiseControlMap:
  ...
  def reset_params(self):
    ...
    # TODO-TOP: mock data from gpsLocation
  ...
  # TODO-TOP: mock data from modelV2 to test other states
