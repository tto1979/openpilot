...
from openpilot.top.selfdrive.controls.lib.smart_cruise_control.vision_controller import SmartCruiseControlVision
...
class TestSmartCruiseControlVision:
  ...
  # TODO-TOP: mock modelV2 data to test other states
